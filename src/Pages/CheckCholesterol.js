...
const CheckCholesterol= () => {
    ...
    const [BreMDHA005, setUsers] = useState([]);
            ...
            <div className='check-value-page-container'>
                <h1>    Cholesterol</h1>
                        <div className="check-value-textbox">
                            ...
                            <p className="check-value-info">Your Cholesterol is</p>
                            <div className="heart-rate">
                                {BreMDHA005.length > 0 && BreMDHA005[0].data !== null ? (
                                    <p className="heart-rate-level">{BreMDHA005[0].data} mg/dL </p>
                                ) : (
                                    <p className="heart-rate-level"> Cholesterol Machine is not Conected !!!</p>
                                )}
                            </div>
                        </div>
